      ...
      transformIndexHtml() {
        ...
        return [{
          ...
          attrs: {
            ...
            content: `default-src 'self'; script-src ${scripts}; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob:; font-src 'self'; media-src 'self' blob:; connect-src ${connections}; object-src 'none'; frame-src 'none'; base-uri 'self'; form-action 'none'`,
          },
